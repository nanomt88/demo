...
public class SyncTaskConsumer {
    ...
    private final Logger logger = LoggerFactory.getLogger(SyncTaskConsumer.class);
    ...
    public void init() throws MQClientException {
        ...
        String groupName = env.getProperty("rocketmq.sync.task.consumerGroup");
        String addr = env.getProperty("rocketmq.namesrvAddr");
        //String instanceName = env.getProperty("rocketmq.instanceName");
        String topic = env.getProperty("rocketmq.sync.task.topic");
       ...
       // assert instanceName != null;
        ...
        logger.info("rocketMQ SyncTaskConsumer start success");
    }
